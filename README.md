...
#### A guide covering the Biostatistics including the applications, libraries and tools that will make you a better and more efficient with Biostatistics development.
...
1. [Biostatistics Learning Resources](https://github.com/mikeroyal/Biostatistics-Guide#biostatistics-learning-resources)

2. [Biostatistics Tools, Libraries, and Frameworks](https://github.com/mikeroyal/Biostatistics-Guide#biostatistics-tools-libraries-and-frameworks)

3. [Machine Learning](https://github.com/mikeroyal/Biostatistics-Guide#machine-learning)

4. [Algorithms](https://github.com/mikeroyal/Biostatistics-Guide#algorithms)

5. [MATLAB Development](https://github.com/mikeroyal/Biostatistics-Guide#matlab-development)

6. [R Development](https://github.com/mikeroyal/Biostatistics-Guide#r-development)

7. [Python Development](https://github.com/mikeroyal/Biostatistics-Guide#python-development)

8. [Ruby Development](https://github.com/mikeroyal/Biostatistics-Guide#ruby-development)

9. [Java Development](https://github.com/mikeroyal/Biostatistics-Guide#java-development)

10. [PHP Development](https://github.com/mikeroyal/Biostatistics-Guide#php-development)

11. [F# Development](https://github.com/mikeroyal/Biostatistics-Guide#F-development)

12. [.NET Development](https://github.com/mikeroyal/Biostatistics-Guide#NET-development)


# Biostatistics Learning Resources
[Back to the Top](https://github.com/mikeroyal/Biostatistics-Guide#table-of-contents)

[Biostatistics](https://phs.weill.cornell.edu/research-collaboration/our-divisions/biostatistics) is the application of statistical techniques for scientific research in health-related fields, including medicine, biology and public health. It also encompasses development of novel methodologies that translate to better study design and analyses.

[Learn Biostatistics with Online Courses and Lessons | edX](https://www.edx.org/learn/biostatistics)

[Top Biostatistics Courses Online | Udemy](https://www.udemy.com/topic/biostatistics/)

[Introduction to Statistics / Biostatistics | Udemy](https://www.udemy.com/course/introduction-to-biostatistics-e/)

[Top Biostatistics Courses | Coursera](https://www.coursera.org/courses?query=biostatistics)

[Biostatistics in Public Health | Coursera](https://www.coursera.org/specializations/biostatistics-public-health)

[Intermediate Biostatistics: Analysis of Discrete Data in Epidemiology](https://online.stanford.edu/courses/hrp261-intermediate-biostatistics-analysis-discrete-data-epidemiology)

[Biostatistics Certificate | UC San Diego Extension](https://extension.ucsd.edu/courses-and-programs/biostatistics-certificate)

[Fundamentals of Biostatistics - Harvard Online Courses](https://online-learning.harvard.edu/course/fundamentals-biostatistics)

[Introduction to Epidemiology and Biostatistics | Harvard](https://online-learning.harvard.edu/course/introduction-epidemiology-and-biostatistics)

[Biostatistics Certificate Program](https://www.statistics.com/certificates/biostatistics-certificate-program/)
...
# Biostatistics Tools, Libraries, and Frameworks
[Back to the Top](https://github.com/mikeroyal/Biostatistics-Guide#table-of-contents)
...
[Clustal Omega](https://www.ebi.ac.uk/Tools/msa/clustalo/) is a new multiple sequence alignment program that uses seeded guide trees and HMM profile-profile techniques to generate alignments between three or more sequences.

[Ensembl](https://www.ensembl.org/) is a genome browser for vertebrate genomes that supports research in comparative genomics, evolution, sequence variation and transcriptional regulation. Ensembl annotate genes, computes multiple alignments, predicts regulatory function and collects disease data.

[InterProScan](https://www.ebi.ac.uk/interpro/search/sequence-search) is atoo that searches sequences against InterPro's predictive protein signatures.

[BLAST](https://www.ebi.ac.uk/Tools/sss/ncbiblast/) is a fast local similarity search tool for protein sequence databases.

[PDBe](https://pdbe.org/) is the European resource for the collection, organisation and dissemination of 3D structural data (from PDB and EMDB) on biological macromolecules and their complexes.

[HMMER](https://www.ebi.ac.uk/Tools/hmmer) is a fast sensitive protein homology searches using profile hidden Markov models (HMMs) for querying against both sequence and HMM target databases.

[ChEMBL](https://www.ebi.ac.uk/chembl/) is an open data resource of binding, functional and ADMET bioactivity data.
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Biostatistics-Guide/pulls).
